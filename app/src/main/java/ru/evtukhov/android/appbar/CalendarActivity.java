        ...
        mBtnOK.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (mStartDate > mEndDate){
                    Toast.makeText(CalendarActivity.this, getString(R.string.app_error), Toast.LENGTH_LONG).show();
                    mChooseStartDate.setText(getString(R.string.app_start));
                    mChooseEndDate.setText(getString(R.string.app_end));
                } else {
                    Toast.makeText(CalendarActivity.this, getString(R.string.app_begin) + mStartDateTxt + getString(R.string.app_finish) + mEndDateTxt, Toast.LENGTH_LONG).show();
                }
            }
        });
    }
